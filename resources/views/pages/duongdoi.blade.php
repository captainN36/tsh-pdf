<div id="pf7" class="pf w0 h0" data-page-no="14">
    <div class="pc pc6 w0 h0 opened">
        <img class="bi x0 y0 w1 h1" alt="" src="{{ asset('/'.$data['data']['lifePathIndicator']['lifePathIndicator'].'/c.png') }}">
...
<div id="pf7" class="pf w0 h0" data-page-no="15">
    <div class="pc pc6 w0 h0 opened">
        <img class="bi x0 y0 w1 h1" alt="" src="{{ asset('/'.$data['data']['lifePathIndicator']['lifePathIndicator'].'/duongdoi.png') }}">
...
<div id="pfd" class="pf w0 h0" data-page-no="26">
    ...
    <div id="pf7" class="pf w0 h0" data-page-no="36">
        <div class="pc pc6 w0 h0 opened">
            <img class="bi x0 y0 w1 h1" alt="" src="{{ asset('/'.$data['data']['lifePathIndicator']['lifePathIndicator'].'/ck-duong-doi.png') }}">
    ...
    <div id="pf7" class="pf w0 h0" data-page-no="38">
        <div class="pc pc6 w0 h0 opened">
            <img class="bi x0 y0 w1 h1" alt="" src="{{ asset('/'.$data['data']['lifePathIndicator']['lifePathIndicator'].'/kim-tu-thap.png') }}">
...
<div id="pf7" class="pf w0 h0" data-page-no="51">
    <div class="pc pc6 w0 h0 opened">
        <img class="bi x0 y0 w1 h1" alt="" src="{{ asset('/'.$data['data']['lifePathIndicator']['lifePathIndicator'].'/suc-manh.png') }}">
...
<div id="pf7" class="pf w0 h0" data-page-no="53">
    <div class="pc pc6 w0 h0 opened">
        <img class="bi x0 y0 w1 h1" alt="" src="{{ asset('/'.$data['data']['lifePathIndicator']['lifePathIndicator'].'/ngay-sinh.png') }}">
        <div class="t m0 x13 hd y93 ff1 fs7 fc0 sc0 ls0 ws0"></div>
...
@isset($data['isCouple'])
    <div id="pf7" class="pf w0 h0" data-page-no="53">
        <div class="pc pc6 w0 h0 opened">
            <img class="bi x0 y0 w1 h1" alt="" src="{{ asset('/'.$data['data']['lifePathIndicator']['lifePathIndicator'].'/vochong.png') }}">
            <div class="t m0 x13 hd y93 ff1 fs7 fc0 sc0 ls0 ws0"></div>
