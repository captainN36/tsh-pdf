...
<div id="pf7-8" class="pf w0 h0" data-page-no="22">
    <div class="pc pc6 w0 h0 opened">
        ...
        <?php
            $maturityIndicator_description = \App\Http\Controllers\PDFController::renderText($data['id'] . '-' . $data['dateSearch'] . '-' . 'maturityIndicator_description', $data['data']['maturityIndicator']['description'], false);
...
<div id="pfd" class="pf w0 h0" data-page-no="37">
    ...
    <div class="pc pc6 w0 h0 opened">
        ...
        <div class="t m0 x14 he y94 ff1 fs8 fc0 sc0 ls0 ws0">CHỈ SỐ TRƯỞNG THÀNH</div>
        <div class="t m0 h7 yd5 ff1 fs3 fc7 sc0 ls0 ws0 index-center">
            {{ $data['data']['repeatIndicator']['repeatIndicator'] }}
        </div>
        <?php
...
<div id="pf7-8" class="pf w0 h0" data-page-no="22">
    <div class="pc pc6 w0 h0 opened">
        ...
        <div class="t m0 x14 he y94 ff1 fs8 fc0 sc0 ls0 ws0">CHỈ SỐ TRƯỞNG THÀNH</div>
        <div class="t m0 h7 yd5 ff1 fs3 fc7 sc0 ls0 ws0 index-center">
            {{ $data['data']['missIndicator']['missIndicator'] }}
        </div>
        <?php
