    ...
    <div id="pf7" class="pf w0 h0" data-page-no="53">
        <div class="pc pc6 w0 h0 opened">
            ...
            <div class="t m0 x51 h14 y1c7 ff1 fsc fc7 sc0 ls0 ws0" style="height: 60.5px; display: inline-flex">
                <span style="color: unset; width: 150px margin-left: 100px" class="_ _24">{{ $name->{3} ?? null }}</span>
                <span style="color: unset; width: 150px margin-left: 200px" class="_ _24"> {{ $name->{6} ?? null }}</span>
                <span style="color: unset; width: 150px margin-left: 300px" class="_ _22">{{ $name->{9} ?? null }} </span>
