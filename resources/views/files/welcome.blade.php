            ...
            <div class="report-table__container">
                <div class="report-table-col report-table-left">
                    ...
                    <div>
                        ...
                        <div class="t m0 h14 y170 ff1 fsc fc2 sc0 ls0 ws0" style="bottom: 393px; left: 200px">{{ $data['data']['challengeIndicator']['challengeIndicator']['firstChallenge']['firstChallengeIndicator'] }}<span class="_ _1b" style="width: 180px;"> </span>{{ $data['data']['challengeIndicator']['challengeIndicator']['secondChallenge']['secondChallengeIndicator'] }}</div>
