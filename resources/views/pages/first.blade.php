...
<div id="pf2" class="pf w0 h0" data-page-no="2">
    <div class="pc pc2 w0 h0 opened">
        <img class="bi x0 y0 w1 h1" alt="" src="/{{ $data['data']['lifePathIndicator']['lifePathIndicator'] }}/page.png">
...
<div id="pf3" class="pf w0 h0" data-page-no="3">
    <div class="pc pc3 w0 h0 opened">
        <img class="bi x0 y0 w1 h1" alt="" src="/{{ $data['data']['lifePathIndicator']['lifePathIndicator'] }}/page-1.png">
...
<div id="pf4" class="pf w0 h0" data-page-no="4">
    <div class="pc pc4 w0 h0 opened">
        <img class="bi x0 y0 w1 h1" alt="" src="/{{ $data['data']['lifePathIndicator']['lifePathIndicator'] }}/phai.png">
...
<div id="pf5" class="pf w0 h0" data-page-no="5">
    <div class="pc pc5 w0 h0 opened"><img class="bi x0 y0 w1 h1" alt="" src="/{{ $data['data']['lifePathIndicator']['lifePathIndicator'] }}/trai.png">
