...
<div id="pfd" class="pf w0 h0" data-page-no="37">
    ...
    <div id="pf7" class="pf w0 h0" data-page-no="51">
        <div class="pc pc6 w0 h0 opened">
            ...
            <div class="t m0 x55 h14 y1c8 ff1 fsc fc7 sc0 ls0 ws0" style="left: 530px">{{ $strength->{5} ?? null }}
            </div>
            <div class="t m0 x55 h14 y1c8 ff1 fsc fc7 sc0 ls0 ws0" style="left: 610px">{{ $strength->{8} ?? null }}
            </div>
            <div class="t m0 x2 h14 y1c9 ff1 fsc fc7 sc0 ls0 ws0">{{ $strength->{1} ?? null }}</div>
            <div class="t m0 x2 h14 y1c9 ff1 fsc fc7 sc0 ls0 ws0" style="left: 530px">{{ $strength->{4} ?? null }}
            </div>
            <div class="t m0 x2 h14 y1c9 ff1 fsc fc7 sc0 ls0 ws0" style="left: 610px">{{ $strength->{7} ?? null }}
            </div>
            @php
                $return = [];
...
@endif
    ...
    <div id="pf7" class="pf w0 h0" data-page-no="53">
        <div class="pc pc6 w0 h0 opened">
            ...
            <div class="t m0 x51 h14 y1c7 ff1 fsc fc7 sc0 ls0 ws0" style="height: 60.5px; display: flex; left: 70px; width: 2360px">
                <span style="color: unset; width: 5px" class="_ _24">{{ $name->{3} ?? null }}</span>
                <span style="color: unset; width: 5px" class="_ _24">{{ $name->{6} ?? null }}</span>
                <span style="color: unset; width: 5px" class="_ _22">{{ $name->{9} ?? null }} </span>
                <span style="color: unset; width: 10px; margin-left: 350px;" class="_ _24">{{ $summary->{3} ?? null }}</span>
                <span style="color: unset; width: 5px" class="_ _24">{{ $summary->{6} ?? null }} </span>
                <span style="color: unset; width: 5px" class="_ _24">{{ $summary->{9} ?? null }} </span>
            </div>

            <div class="t m0 x51 h14 y1c7 ff1 fsc fc7 sc0 ls0 ws0" style="height: 60.5px;display: flex;top: 198px; left: 70px; width: 2360px">
                <span style="color: unset; width: 5px" class="_ _24">{{ $name->{2} ?? null }}</span>
                <span style="color: unset; width: 5px" class="_ _24">{{ $name->{5} ?? null }}</span>
                <span style="color: unset; width: 5px" class="_ _22">{{ $name->{8} ?? null }} </span>
                <span style="color: unset; width: 10px; margin-left: 350px;" class="_ _24">{{ $summary->{2} ?? null }}</span>
                <span style="color: unset; width: 5px" class="_ _24">{{ $summary->{5} ?? null }} </span>
                <span style="color: unset; width: 5px" class="_ _24">{{ $summary->{8} ?? null }} </span>
            </div>
            <div class="t m0 x51 h14 y1c7 ff1 fsc fc7 sc0 ls0 ws0" style="height: 60.5px;display: flex;top: 260px; left: 70px; width: 2360px">
                <span style="color: unset; width: 5px" class="_ _24">{{ $name->{1} ?? null }}</span>
                <span style="color: unset; width: 5px" class="_ _24"> {{ $name->{4} ?? null }}</span>
                <span style="color: unset; width: 5px" class="_ _22">{{ $name->{7} ?? null }} </span>
                <span style="color: unset; width: 10px; margin-left: 350px;" class="_ _24">{{ $summary->{1} ?? null }}</span>
                <span style="color: unset; width: 5px" class="_ _24">{{ $summary->{4} ?? null }} </span>
                <span style="color: unset; width: 5px" class="_ _24">{{ $summary->{7} ?? null }} </span>
            </div>
...
@endif
    ...
    <div id="pf7" class="pf w0 h0" data-page-no="54">
        <div class="pc pc6 w0 h0 opened">
            ...
            <div class="t m0 h14 y166 ff1 fsc fc2 sc0 ls0 ws0" style="bottom: 452px; left: 109px">3</div>
            <div class="t m0 h14 y166 ff1 fsc fc2 sc0 ls0 ws0" style="bottom: 452px; left: 240px">1</div>
            <div class="t m0 h14 y166 ff1 fsc fc2 sc0 ls0 ws0" style="bottom: 452px; left: 370px">3</div>
            ...
            <div class="t m0 h14 y167 ff1 fsc fc2 sc0 ls0 ws0" style="bottom: 495px; left: 278px">{{ $data['data']['challengeIndicator']['challengeIndicator']['secondChallenge']['secondPeakIndicator'] }}</div>
            <div class="t m0 h14 y16a ff1 fsc fc2 sc0 ls0 ws0" style="bottom: 545px; left: 238px">{{ $data['data']['challengeIndicator']['challengeIndicator']['thirdChallenge']['thirdPeakIndicator'] }}</div>
            <div class="t m0 h14 y16d ff1 fsc fc2 sc0 ls0 ws0" style="bottom: 595px; left: 240px">{{ $data['data']['challengeIndicator']['challengeIndicator']['fourthChallenge']['fourthPeakIndicator'] }}</div>
            <div class="t m0 h14 y170 ff1 fsc fc2 sc0 ls0 ws0" style="bottom: 395px; left: 203px">{{ $data['data']['challengeIndicator']['challengeIndicator']['firstChallenge']['firstChallengeIndicator'] }}<span class="_ _1b" style="width: 170px;"> </span>{{ $data['data']['challengeIndicator']['challengeIndicator']['secondChallenge']['secondChallengeIndicator'] }}</div>
