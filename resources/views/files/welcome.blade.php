...
@endif
    ...
    <div id="pf7" class="pf w0 h0" data-page-no="53">
        <div class="pc pc6 w0 h0 opened">
            ...
            <div class="t m0 x51 h14 y1c7 ff1 fsc fc7 sc0 ls0 ws0" style="height: 60.5px; display: flex; left: 65px">
                <span style="color: unset; width: 1px !important"></span>{{ $name->{3} ?? "null" }}
                <span style="color: unset; width: 1px !important"></span> {{ $name->{6} ?? "null" }}
                <span style="color: unset; width: 1px !important"> </span>{{ $name->{9} ?? "null" }}
