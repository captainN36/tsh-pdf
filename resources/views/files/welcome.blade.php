    ...
    <div id="pf7" class="pf w0 h0" data-page-no="53">
        <div class="pc pc6 w0 h0 opened">
            ...
            <div class="t m0 x51 h14 y1c7 ff1 fsc fc7 sc0 ls0 ws0" style="height: 60.5px; display: flex; left: 70px; width: 2360px">
                <span style="color: unset; width: 10px" class="_ _24">{{ $name->{3} ?? "nil" }}</span>
                <span style="color: unset; width: 10px" class="_ _24">{{ $name->{6} ?? "nil" }}</span>
                <span style="color: unset; width: 10px" class="_ _22">{{ $name->{9} ?? null }} </span>
                <span style="color: unset; width: 10px; margin-left: 100px;" class="_ _24">{{ $summary->{3} ?? "nil" }}</span>
                <span style="color: unset; width: 10px" class="_ _24">{{ $summary->{6} ?? "nil" }} </span>
                <span style="color: unset; width: 10px" class="_ _24">{{ $summary->{9} ?? "nil" }} </span>
            </div>

            <div class="t m0 x51 h14 y1c7 ff1 fsc fc7 sc0 ls0 ws0" style="height: 60.5px;display: flex;top: 198px; left: 70px; width: 2360px">
                <span style="color: unset; width: 10px" class="_ _24">{{ $name->{2} ?? "nil" }}</span>
                <span style="color: unset; width: 10px" class="_ _24">{{ $name->{5} ?? "nil" }}</span>
                <span style="color: unset; width: 10px" class="_ _22">{{ $name->{8} ?? null }} </span>
                <span style="color: unset; width: 10px; margin-left: 100px;" class="_ _24">{{ $summary->{2} ?? "nil" }}</span>
                <span style="color: unset; width: 10px" class="_ _24">{{ $summary->{5} ?? "nil" }} </span>
                <span style="color: unset; width: 10px" class="_ _24">{{ $summary->{8} ?? "nil" }} </span>
            </div>
            <div class="t m0 x51 h14 y1c7 ff1 fsc fc7 sc0 ls0 ws0" style="height: 60.5px;display: flex;top: 260px; left: 70px; width: 2360px">
                <span style="color: unset; width: 10px" class="_ _24">{{ $name->{1} ?? "nil" }}</span>
                <span style="color: unset; width: 10px" class="_ _24"> {{ $name->{4} ?? "nil" }}</span>
                <span style="color: unset; width: 10px" class="_ _22">{{ $name->{7} ?? "nil" }} </span>
                <span style="color: unset; width: 10px; margin-left: 100px;" class="_ _24">{{ $summary->{1} ?? "nil" }}</span>
                <span style="color: unset; width: 10px" class="_ _24">{{ $summary->{4} ?? "nil" }} </span>
                <span style="color: unset; width: 10px" class="_ _24">{{ $summary->{7} ?? "nil" }} </span>
            </div>
