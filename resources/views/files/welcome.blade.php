...
<div id="pfd" class="pf w0 h0" data-page-no="37">
    ...
    <div id="pf7" class="pf w0 h0" data-page-no="53">
        <div class="pc pc6 w0 h0 opened">
            ...
            <div class="t m0 x51 h14 y1c7 ff1 fsc fc7 sc0 ls0 ws0" style="height: 60.5px; display: flex; width: 2000px; left: 200px">
                <span style="color: unset; width: 100px !important" class="_ _24">{{ $name->{3} ?? null }}</span>
                <span style="color: unset; width: 100px !important" class="_ _24"> {{ $name->{6} ?? null }}</span>
                <span style="color: unset; width: 100px !important" class="_ _22">{{ $name->{9} ?? null }} </span>
                <span style="color: unset; width: 191px; margin-left: 100px;" class="_ _24">{{ $summary->{3} ?? null }}aaa</span>
                <span style="color: unset; width: 191px" class="_ _24">{{ $summary->{6} ?? null }} ssss</span>
                <span style="color: unset; width: 191px" class="_ _24">{{ $summary->{9} ?? null }} dddd</span>
            </div>
