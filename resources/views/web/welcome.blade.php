    ...
    <div id="page-container">
        ...
        <div id="pfd" class="pf w0 h0" data-page-no="12">
            <div class="pc pcb w0 h0 opened">
                ...
                <div class="t m0 x4d h12 y68 ff3 fs4 fc7 sc0 ls0 ws0">Tháng {{ now()->month + 2 }}
                </div>
        ...
        <div id="pf7" class="pf w0 h0" data-page-no="33">
            <div class="pc pc6 w0 h0 opened">
                ...
                <div class="t m0 h7 yd5 ff1 fs3 fc7 sc0 ls0 ws0 index-center">
                    {{ $data['data']['natureIndicator']['natureIndicator'] }}
                </div>
                <?php
                $natureIndicator1 = contentText($data['data']['natureIndicator']['data'][0]);
                ?>
                <div class="t m0 x5 hf yd7 ff2 fs4 fc2 sc0 ls0 ws0"
                    style="white-space: normal; width: 2000px; bottom: 900px; text-align: justify;">
        ...
        @if (count($natureIndicator1) >= 2)
            @for ($i = 1; $i < count($natureIndicator1); $i++)
                <?php $page++; ?>
                <div id="pfc" class="pf w0 h0" data-page-no="9">
                    <div class="pc pce w0 h0 opened">
                        <img class="bi x0 y0 w1 h1" alt=""
        ...
        <div id="pf7" class="pf w0 h0" data-page-no="36">
            <div class="pc pc6 w0 h0 opened">
                ...
                ?>
                        <table class="t m0 x3c h13 y124 ff1 fsb fc8 sc0 ls0 ws0" style="left: 160px; width: 2000px; text-align: center; bottom: 1150px">
                            <tr>
        ...
        <div id="pf7" class="pf w0 h0" data-page-no="54">
            <div class="pc pc6 w0 h0 opened">
                <img class="bi x0 y0 w1 h1" style="width: 914px" alt="" src="{{ asset('/' . $path . '/vochong.png') }}">
                ...
                @include('footer')
                <div style="left: 817px" class="t m0 x3a h5 y61 ff2 fs2 fc0 sc0 ls0 ws0">{{ $page + 1 }}</div>
                <div class="pi"
                    data-data="{&quot;ctm&quot;:[1.500000,0.000000,0.000000,1.500000,0.000000,0.000000]}">
                </div>
            </div>
