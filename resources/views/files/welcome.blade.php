...
@endif
    ...
    <div id="pf7" class="pf w0 h0" data-page-no="53">
        <div class="pc pc6 w0 h0 opened">
            ...
            <div class="t m0 x55 h14 y1c7 ff1 fsc fc7 sc0 ls0 ws0" style="left: 690px">{{ $sumary->{3} ?? "null" }}</div>
            <div class="t m0 h14 y1c7 ff1 fsc fc7 sc0 ls0 ws0" style="left: 780px">{{ $sumary->{6} ?? "null" }}</div>
            <div class="t m0 h14 y1c7 ff1 fsc fc7 sc0 ls0 ws0" style="left: 870px">{{ $sumary->{9} ?? "null" }}</div>
            <div class="t m0 x55 h14 y1c8 ff1 fsc fc7 sc0 ls0 ws0" style="left: 690px">{{ $sumary->{2} ?? "null" }}</div>
            <div class="t m0 x55 h14 y1c8 ff1 fsc fc7 sc0 ls0 ws0" style="left: 780px">{{ $sumary->{5} ?? "null" }}</div>
            <div class="t m0 x55 h14 y1c8 ff1 fsc fc7 sc0 ls0 ws0" style="left: 870px">{{ $sumary->{8} ?? "null" }}</div>
            <div class="t m0 x2 h14 y1c9 ff1 fsc fc7 sc0 ls0 ws0" style="left: 690px">{{ $sumary->{1} ?? "null" }}</div>
            <div class="t m0 x2 h14 y1c9 ff1 fsc fc7 sc0 ls0 ws0" style="left: 780px">{{ $sumary->{4} ?? "null" }}</div>
            <div class="t m0 x2 h14 y1c9 ff1 fsc fc7 sc0 ls0 ws0" style="left: 870px">{{ $sumary->{7} ?? "null" }}</div>
