<div id="pf6" class="pf w0 h0" data-page-no="6">
    <div class="pc pc7 w0 h0 opened">
        <img class="bi x0 y0 w1 h1" alt="" src="/{{ $data['data']['lifePathIndicator']['lifePathIndicator'] }}/1.png">
        <div class="t m0 x13 hd y93 ff1 fs7 fc0 sc0 ls0 ws0">1</div><div class="t m0 x14 he y94 ff1 fs8 fc0 sc0 ls0 ws0">TỔNG HỢP CÁC CHỈ SỐ QUAN TRỌNG</div>
        ...
        <div class="t m0 x3 hc y97 ff1 fs6 fc0 sc0 ls0 ws0">{{ $data['data']['lifePathIndicator']['lifePathIndicator'] }}<span class="_ _10"> </span>{{ $data['data']['attitudeIndicator']['attitudeIndicator'] }}<span class="_ _10"> </span>{{ $data['data']['maturityIndicator']['maturityIndicator'] }}</div>
