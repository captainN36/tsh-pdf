<div id="pf6" class="pf w0 h0" data-page-no="6">
    <div class="pc pc7 w0 h0 opened">
        ...
        <div class="t m0 x3 hc y97 ff1 fs6 fc0 sc0 ls0 ws0 chiso" style="display: flex;justify-content: space-between;align-items: center; left: 55px; bottom: 969px;gap: 200px;">
        ...
        <div class="t m0 x3 hc y97 ff1 fs6 fc0 sc0 ls0 ws0 chiso" style="display: flex;justify-content: space-between;align-items: center; left: 55px; bottom: 730px;gap: 200px; width: 215vw">
            <div class="item" style="flex: 1; text-align: center; margin: 0; padding: 0;">
        ...
        <div class="t m0 x3 hc y97 ff1 fs6 fc0 sc0 ls0 ws0 chiso" style="display: flex;justify-content: space-between;align-items: center; left: 55px; bottom: 490px;gap: 200px; width: 215vw">
            <div class="item" style="flex: 1; text-align: center; margin: 0; padding: 0;">
                <p>{{ $data['data']['missionIndicator']['missionIndicator'] }}</p>
            </div>
            <div class="item" style="flex: 1; text-align: center; margin: 0; padding: 0;">
        ...
        <div class="t m0 x3 hc y97 ff1 fs6 fc0 sc0 ls0 ws0 chiso" style="display: flex;justify-content: space-between;align-items: center; left: 55px; bottom: 250px;gap: 200px; width: 215vw">
            <div class="item" style="flex: 1; text-align: center; margin: 0; padding: 0;">
