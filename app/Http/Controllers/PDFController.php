...
class PDFController extends Controller
{
    ...
    public function pdf($param)
    {
        ...
        $html = '<p><br></p><p><br></p><p><br></p><p><br></p><p><br></p><p><br></p><p><br></p><p><br></p><p><br></p><p><br></p><p><br></p><p><br></p><h2><strong>Viết hướng dẫn một cách rõ ràng</strong></h2><h3>Chứa các thông tin chi tiết vào trong query để câu trả lời liên quan hơn</h3><ul><li>Chắc hẳn ai cũng biết, muốn người khác trả lời đúng ý mình thì câu hỏi mình đặt ra cũng cần rõ ràng, cụ thể để đối phương hiểu. ChatGPT mạnh, nhưng nó sẽ thực sự mạnh khi bạn nói rõ ràng cho nó hiểu. Nội dung cần rõ ràng, chi tiết hoặc có bối cảnh cụ thể\</li><li>Ví dụ thay vì hỏi "Viết đoạn code tính dãy Fibonacci", bạn có thể yêu cầu nó cụ thể hơn như "Hãy viết cho tôi mọt đoạn mã Python tính dãy Fibonacci, đồng thời hãy thêm các comment để giải thích chức năng theo từng phần"</li></ul><h3><strong>Yêu cầu model chấp nhận một nhân cách nào đó</strong></h3><ul><li>Thay vì trả lời một cách nghiêm túc hoặc dập khuôn, bạn có thể yêu cầu ChatGPT trả lời một cách hài hước, vui tươi. Chiến lược này sẽ khá phù hợp khi các bạn yêu cầu nó gợi ý một bài phát biểu hay một đoạn văn nào đó</li></ul><h3><strong>Sử dụng các dấu phân cách để phân tách rõ các phần trong input</strong></h3><ul><li>Lúc mới sử dụng ChatGPT, mình có thiên hướng kiểu coi nó như một người bạn và hỏi nó khá là lộn xộn, mỗi câu lại hỏi nói một ý, nó trả lời không đúng thì hỏi lại nó. Điều này khá tốn thời gian và đôi khi không hiệu quả (Vì ChatGPT chỉ nhớ được một lượng chat trong quá khứ một cách giới hạn). Làm một vài dự án sử dụng ChatGPT, mình mới thấy việc phân cách trong prompt nó quan trọng thế nào</li><li>Bạn nên sử dụng các dấu như ngoặc kép ba, thẻ XML, tiêu đề phần, ... để phân định rõ ràng các phần cần được xử lý. Ví dụ</li><li>	Tất nhiên với các task đơn giản thì các bạn sẽ chưa thấy rõ được ưu điểm của chiến lược này nhưng nếu làm các task phức tạp như đưa ra câu trả lời từ câu hỏi và các tài liệu đính kèm, hay phân loại hội thoại vào các nhóm chỉ định thì bạn sẽ thấy hiệu quả to lớn của chiến lược này</li><li>nhóm chỉ định thì bạn sẽ thấy hiệu quả to lớn của chiến lược này</li></ul><p><br></p><></><p><br></p><p><br></p><p><br></p><h2><strong>Viết hướng dẫn một cách rõ ràng</strong></h2><h3>Chứa các thông tin chi tiết vào trong query để câu trả lời liên quan hơn</h3><ul><li>Chắc hẳn ai cũng biết, muốn người khác trả lời đúng ý mình thì câu hỏi mình đặt ra cũng cần rõ ràng, cụ thể để đối phương hiểu. ChatGPT mạnh, nhưng nó sẽ thực sự mạnh khi bạn nói rõ ràng cho nó hiểu. Nội dung cần rõ ràng, chi tiết hoặc có bối cảnh cụ thể\</li><li>Ví dụ thay vì hỏi "Viết đoạn code tính dãy Fibonacci", bạn có thể yêu cầu nó cụ thể hơn như "Hãy viết cho tôi mọt đoạn mã Python tính dãy Fibonacci, đồng thời hãy thêm các comment để giải thích chức năng theo từng phần"</li></ul><h3><strong>Yêu cầu model chấp nhận một nhân cách nào đó</strong></h3><ul><li>Thay vì trả lời một cách nghiêm túc hoặc dập khuôn, bạn có thể yêu cầu ChatGPT trả lời một cách hài hước, vui tươi. Chiến lược này sẽ khá phù hợp khi các bạn yêu cầu nó gợi ý một bài phát biểu hay một đoạn văn nào đó</li></ul><h3><strong>Sử dụng các dấu phân cách để phân tách rõ các phần trong input</strong></h3><ul><li>Lúc mới sử dụng ChatGPT, mình có thiên hướng kiểu coi nó như một người bạn và hỏi nó khá là lộn xộn, mỗi câu lại hỏi nói một ý, nó trả lời không đúng thì hỏi lại nó. Điều này khá tốn thời gian và đôi khi không hiệu quả (Vì ChatGPT chỉ nhớ được một lượng chat trong quá khứ một cách giới hạn). Làm một vài dự án sử dụng ChatGPT, mình mới thấy việc phân cách trong prompt nó quan trọng thế nào</li><li>Bạn nên sử dụng các dấu như ngoặc kép ba, thẻ XML, tiêu đề phần, ... để phân định rõ ràng các phần cần được xử lý. Ví dụ</li><li>	Tất nhiên với các task đơn giản thì các bạn sẽ chưa thấy rõ được ưu điểm của chiến lược này nhưng nếu làm các task phức tạp như đưa ra câu trả lời từ câu hỏi và các tài liệu đính kèm, hay phân loại hội thoại vào các nhóm chỉ định thì bạn sẽ thấy hiệu quả to lớn của chiến lược này</li><li>nhóm chỉ định thì bạn sẽ thấy hiệu quả to lớn của chiến lược này</li><li>	Tất nhiên với các task đơn giản thì các bạn sẽ chưa thấy rõ được ưu điểm của chiến lược này nhưng nếu làm các task phức tạp như đưa ra câu trả lời từ câu hỏi và các tài liệu đính kèm, hay phân loại hội thoại vào các nhóm chỉ định thì bạn sẽ thấy hiệu quả to lớn của chiến lược này</li><li>nhóm chỉ định thì bạn sẽ thấy hiệu quả to lớn của chiến lược này</li><li>	Tất nhiên với các task đơn giản thì các bạn sẽ chưa thấy rõ được ưu điểm của chiến lược này nhưng nếu làm các task phức tạp như đưa ra câu trả lời từ câu hỏi và các tài liệu đính kèm, hay phân loại hội thoại vào các nhóm chỉ định thì bạn sẽ thấy hiệu quả to lớn của chiến lược này</li></ul><p><br></p>';
            $html = explode('<></>', $html);
