...
class PDFController extends Controller
{
    ...
    public function pdf($param)
    {
        ...
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <p><strong>1. Chu kỳ đầu ti&ecirc;n (GIEO HẠT) từ Đầu đời - 30 tuổi (2029), ứng với số 3</strong></p>
        <p>Trong thời kỳ tuổi trẻ, bạn muốn thể hiện bản th&acirc;n bằng bất cứ gi&aacute; n&agrave;o, bạn cũng c&oacute; xu hướng cực đoan. Bạn c&oacute; thể l&agrave; một người th&iacute;ch tr&ograve; chuyện vui vẻ, trừ khi bạn c&oacute; cơ hội ra ngo&agrave;i v&agrave; ở b&ecirc;n mọi người nhiều nhất c&oacute; thể. Mặc d&ugrave; việc học ch&iacute;nh thức c&oacute; thể khiến bạn bồn chồn, nhưng bạn c&oacute; thể sẽ ph&aacute;t triển mạnh mẽ khi chuyển nguồn năng lượng dồi d&agrave;o của m&igrave;nh v&agrave;o c&aacute;c lĩnh vực nghệ thuật, kịch, &acirc;m nhạc hoặc c&aacute;c h&igrave;nh thức thể hiện bản th&acirc;n kh&aacute;c. Đ&acirc;y l&agrave; một giai đoạn đường đời tuyệt vời đối với một người trẻ tuổi v&igrave; n&oacute; c&oacute; khuynh hướng ph&aacute;t triển biểu hiện. Bất kỳ t&agrave;i năng n&agrave;o bạn c&oacute; thể c&oacute; trong kịch, &acirc;m nhạc hoặc nghệ thuật đều được khuyến kh&iacute;ch trong giai đoạn n&agrave;y. Bạn c&oacute; thể c&oacute; cảm x&uacute;c cao v&agrave; c&oacute; thể c&oacute; xu hướng hiếu động. Việc kết bạn v&agrave; tận hưởng c&aacute;c tương t&aacute;c x&atilde; hội sẽ trở n&ecirc;n dễ d&agrave;ng ngay b&acirc;y giờ. H&atilde;y tận hưởng cuộc sống, nhưng h&atilde;y cẩn thận đừng ph&acirc;n t&aacute;n c&aacute;c hoạt động của bạn đến mức bạn kh&ocirc;ng đạt được tiến bộ trong bất cứ điều g&igrave;.</p>
        <p><strong>2. Chu kỳ 2 (CH&Iacute;N) từ 31 - 57 tuổi (2030 - 2056), ứng với số 2</strong></p>
        <p>V&agrave;o giữa cuộc đời, th&agrave;nh c&ocirc;ng của bạn sẽ nảy sinh th&ocirc;ng qua sự hợp t&aacute;c. Bạn n&ecirc;n t&igrave;m kiếm c&ocirc;ng việc li&ecirc;n quan đến việc gi&uacute;p đỡ mọi người h&ograve;a thuận với nhau. Đặt bản th&acirc;n l&agrave; thứ hai, ch&uacute; &yacute; đến chi tiết v&agrave; nhạy cảm với nhu cầu của người kh&aacute;c. Đ&acirc;y cũng l&agrave; một chu kỳ tuyệt vời để cải thiện mối quan hệ đối t&aacute;c v&agrave; h&ocirc;n nh&acirc;n của bạn. Trong những năm n&agrave;y, khả năng sử dụng c&aacute;c kỹ năng ngoại giao v&agrave; h&ograve;a giải của bạn sẽ được ph&aacute;t huy r&otilde; rệt. C&ocirc;ng việc của người kh&aacute;c v&agrave; th&agrave;nh c&ocirc;ng của họ c&oacute; thể l&agrave; ch&igrave;a kh&oacute;a cho sự thăng tiến của ch&iacute;nh bạn. Việc th&uacute;c đẩy c&aacute;c dự &aacute;n của ri&ecirc;ng bạn trong giai đoạn n&agrave;y cũng kh&ocirc;ng hợp l&yacute;. Việc cần thiết l&agrave; kiểm so&aacute;t những cảm x&uacute;c hiếu động c&oacute; thể xuất hiện theo thời gian.</p>
        <p><strong>3. Chu kỳ cuối (THU HOẠCH) từ 58 tuổi về sau (2057 về sau), ứng với số 1</strong></p>
        <p>Những năm sau n&agrave;y của bạn c&oacute; thể năng động v&agrave; gi&agrave;u th&agrave;nh t&iacute;ch nếu bạn c&oacute; thể tự chủ. Bạn sẽ phải phụ thuộc v&agrave;o bản th&acirc;n v&agrave; chọn con đường cho ri&ecirc;ng m&igrave;nh,</p>
        <></><p>nhưng bạn sẽ kh&ocirc;ng bao giờ cảm thấy nh&agrave;m ch&aacute;n. Tập trung v&agrave;o những &yacute; tưởng mới hoặc tạo sức sống mới cho những &yacute; tưởng cũ. Cần phải c&oacute; đủ h&agrave;nh động để giữ cho bạn đi đến cuối c&ugrave;ng. Trong giai đoạn n&agrave;y, bạn c&oacute; thể đạt được sự c&ocirc;ng nhận m&agrave; bạn đ&atilde; bỏ qua sẽ</p>';
            $html = explode('<></>', $html);
