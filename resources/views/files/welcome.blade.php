...
@endif
    ...
    <div id="pf7" class="pf w0 h0" data-page-no="53">
        <div class="pc pc6 w0 h0 opened">
            ...
            <div class="t m0 x51 h14 y1c7 ff1 fsc fc7 sc0 ls0 ws0" style="height: 60.5px; display: flex; left: 80px">
                <span style="color: unset; width: 5px !important" class="_ _24">{{ $name->{3} ?? "null" }}</span>
                <span style="color: unset; width: 5px !important; margin-left: -10px !important" class="_ _24"> {{ $name->{6} ?? "null" }}</span>
                <span style="color: unset; width: 5px !important; margin-left: -10px !important" class="_ _22">{{ $name->{9} ?? "null" }} </span>
                <span style="color: unset; width: 40px; margin-left: 100px;" class="_ _24">{{ $summary->{3} ?? "null" }}</span>
                <span style="color: unset; width: 10px" class="_ _24">{{ $summary->{6} ?? "null" }} </span>
                <span style="color: unset; width: 10px" class="_ _24">{{ $summary->{9} ?? "null" }} </span>
            </div>
        ...
        <div class="pc pc6 w0 h0 opened">
            ...
            <div class="t m0 x51 h14 y1c8 ff1 fsc fc7 sc0 ls0 ws0" style="left: 45px;bottom: 1300px; height: 77px">
             ...
             <div class="t m0 x51 h14 y1c8 ff1 fsc fc7 sc0 ls0 ws0" style="left: 45px;bottom: 1240px">
                {{ $name->{2} ?? null }}<span class="_ _21"></span>{{ $name->{5} ?? null }}<span class="_ _24" style="width: 100px"> </span>{{ $name->{8} ?? null }}<span class="_ _27" style="width: 1320px;"> </span><span style="bottom: 65px;right: 100px;">{{ $data['data']['personalIndicator']['personalIndicator'] }}</span>
            </div>
            ...
            <div class="t m0 x51 h14 y1c8 ff1 fsc fc7 sc0 ls0 ws0" style="left: 35px;bottom: 1050px">
                {{ $summary->{3} ?? null }}<span class="_ _21"></span>{{ $summary->{6} ?? null }}<span class="_ _24" style="width: 150px"> </span>{{ $summary->{9} ?? null }}<span class="_ _27" style="width: 1210px;"> </span><span style="top: -135px">{{ $data['data']['soulIndicator']['soulIndicator'] }}</span>
            </div>
            <div class="t m0 x51 h14 y1c8 ff1 fsc fc7 sc0 ls0 ws0" style="left: 35px;bottom: 980px">
                {{ $summary->{2} ?? null }}<span class="_ _21" style="width: 110px"></span>{{ $summary->{5} ?? null }}<span class="_ _24" style="width: 110px"> </span>{{ $summary->{8} ?? null }}<span class="_ _27" style="width: 1200px;"> </span><span style="top: -200px">{{ implode(', ', $data['data']['passionIndicator']['passionIndicator']) }}</span>
            </div>
            <div class="t m0 x51 h14 y1c8 ff1 fsc fc7 sc0 ls0 ws0" style="left: 35px;bottom: 910px; width: 150px">
                {{ $summary->{1} ?? null }}<span class="_ _21" style="width: 110px"></span>{{ $summary->{4} ?? null }}<span class="_ _24" style="width: 130px"> </span>{{ $summary->{7} ?? null }}<span class="_ _27" style="width: 1280px;"> </span><span style="top: -275px">{{ $data['data']['thinkingIndicator']['thinkingIndicator'] }}</span>
            </div>
