    ...
    <div id="pf7" class="pf w0 h0" data-page-no="54">
        <div class="pc pc6 w0 h0 opened">
            ...
            <div class="t m0 x51 h14 y1c8 ff1 fsc fc7 sc0 ls0 ws0" style="left: 35px; bottom: 910px">
                @php
                    $passionIndicator = $data['data']['passionIndicator']['passionIndicator'];

                    if (count($passionIndicator) <= 4) {
                        $passionIndicator = $passionIndicator;
                    } else {
                        $array1 = array_slice($passionIndicator, 0, 5);
                        $array2 = array_slice($passionIndicator, 5);
                    }
                @endphp
