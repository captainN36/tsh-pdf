...
<div id="pf7" class="pf w0 h0" data-page-no="17">
    <div class="pc pc6 w0 h0 opened">
        ...
        <?php
            $br = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
            $lifePathIndicator = \App\Http\Controllers\PDFController::renderText($data['id'] . '-' . $data['dateSearch'] . 'lifePathIndicator', "<p>". $br.$br.$br.$br.$br.$br.$br.$br.$br . "</p>" .$data['data']['lifePathIndicator']['content'], false);
            $inputString = '';
