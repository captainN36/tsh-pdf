    ...
    <div id="pf7" class="pf w0 h0" data-page-no="54">
        <div class="pc pc6 w0 h0 opened">
            ...
            <div class="t m0 x51 h14 y1c8 ff1 fsc fc7 sc0 ls0 ws0" style="left: 50px;bottom: 1120px;height: 85px;">
                {{ $name->{1} ?? null }}<span class="_ _21"></span>{{ $name->{4} ?? null }}<span class="_ _24" style="width: 200px"> </span>{{ $name->{7} ?? null }}<span class="_ _27" style="width: 1520px;"> </span><span style="top: -115px">{{ $data['data']['attitudeIndicator']['attitudeIndicator'] }}</span>
            </div>
            <div class="t m0 x51 h14 y1c8 ff1 fsc fc7 sc0 ls0 ws0" style="left: 35px;bottom: 980px">
                {{ $summary->{3} ?? null }}<span class="_ _21" style="width: 110px"></span>{{ $summary->{6} ?? "555" }}<span class="_ _24" style="width: 170px"> </span>{{ $summary->{9} ?? null }}<span class="_ _27" style="width: 1360px;"> </span><span style="top: -125px">{{ $data['data']['soulIndicator']['soulIndicator'] }}</span>
            </div>
            ...
            <div class="t m0 x51 h14 y1c8 ff1 fsc fc7 sc0 ls0 ws0" style="left: 35px;bottom: 820px; width: 150px">
                {{ $summary->{1} ?? null }}<span class="_ _21" style="width: 120px"></span>{{ $summary->{4} ?? "222" }}<span class="_ _24" style="width: 170px"> </span>{{ $summary->{7} ?? null }}<span class="_ _27" style="width: 1500px;"> </span><span style="top: -255px">{{ $data['data']['thinkingIndicator']['thinkingIndicator'] }}</span>
            </div>
