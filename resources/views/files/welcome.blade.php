...
@endif
    ...
    <div id="pf7" class="pf w0 h0" data-page-no="53">
        <div class="pc pc6 w0 h0 opened">
            ...
            <div class="t m0 x51 h14 y1c7 ff1 fsc fc7 sc0 ls0 ws0" style="height: 60.5px; display: flex; left: 80px; width: 2160px">
                <span style="color: unset; width: 5px" class="_ _24">{{ $name->{3} ?? "nil" }}</span>
                <span style="color: unset; width: 5px; margin-left: 10px;" class="_ _24">{{ $name->{6} ?? "nil" }}</span>
                <span style="color: unset; width: 5px; margin-left: 10px;" class="_ _22">{{ $name->{9} ?? "nil" }} </span>
                <span style="color: unset; width: 250px; margin-left: 250px;" class="_ _24">{{ $summary->{3} ?? "nil" }}</span>
                <span style="color: unset; width: 5px; margin-left: 30px;" class="_ _24">{{ $summary->{6} ?? "nil" }} </span>
                <span style="color: unset; width: 5px; margin-left: 30px" class="_ _24">{{ $summary->{9} ?? "nil" }} </span>
            </div>

            <div class="t m0 x51 h14 y1c7 ff1 fsc fc7 sc0 ls0 ws0" style="height: 60.5px;display: flex;top: 198px; left: 80px; width: 2360px">
            ...
            <div class="t m0 x51 h14 y1c7 ff1 fsc fc7 sc0 ls0 ws0" style="height: 60.5px;display: flex;top: 260px; left: 80px; width: 2360px">
