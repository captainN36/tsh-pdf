    ...
    <div id="pf7" class="pf w0 h0" data-page-no="54">
        <div class="pc pc6 w0 h0 opened">
            ...
            <div class="t m0 x51 h14 y1c8 ff1 fsc fc7 sc0 ls0 ws0" style="left: 35px; bottom: 910px">
                {{ $summary->{2} ?? null }}<span class="_ _21" style="width: 140px"></span>{{ $summary->{5} ?? null }}<span class="_ _24" style="width: 120px"> </span>{{ $summary->{8} ?? null }}<span class="_ _27" style="width: 1400px;"> </span><span style="bottom: 270px;@if(count($data['data']['passionIndicator']['passionIndicator']) > 3) font-size: 41px @else font-size: 46px  @endif">{{ implode(', ', $data['data']['passionIndicator']['passionIndicator']) }}</span>@if(count($data['data']['passionIndicator']['passionIndicator']) > 3) <span style="bottom: 290px; font-size: 41px; display: flex; left: 2175px">{{ implode(', ', $data['data']['passionIndicator']['passionIndicator']) }}, 4</span> @endif
            </div>
