    ...
    <div id="pf7" class="pf w0 h0" data-page-no="54">
        <div class="pc pc6 w0 h0 opened">
            ...
            <div class="t m0 x51 h14 y1c8 ff1 fsc fc7 sc0 ls0 ws0" style="left: 45px;bottom: 640px">
                <span class="_ _27" style="width: 1640px;"> </span><span style="bottom: 870px">{{ $data['data']['emotionalThinkingIndicator']['emotionalThinkingIndicator'] }}aaaa</span>
            </div>
            <div class="t m0 x51 h14 y1c8 ff1 fsc fc7 sc0 ls0 ws0" style="left: 45px;bottom: 600px">
                <span class="_ _27" style="width: 1640px;"> </span><span style="bottom: 850px">{{ $data['data']['intuitiveThinkingIndicator']['intuitiveThinkingIndicator'] }}aaaa</span>
            </div>
            <div class="t m0 x51 h14 y1c8 ff1 fsc fc7 sc0 ls0 ws0" style="left: 45px;bottom: 560px">
                <span class="_ _27" style="width: 1640px;"> </span><span style="bottom: 780px">{{ $data['data']['actionThinkingIndicator']['actionThinkingIndicator'] }}aaaa</span>
            </div>
