    ...
    <div id="pf7" class="pf w0 h0" data-page-no="54">
        <div class="pc pc6 w0 h0 opened">
            ...
            <div class="t m0 x51 h14 y1c8 ff1 fsc fc7 sc0 ls0 ws0" style="left: 45px;bottom: 250px">
                <span class="_ _27" style="width: 1600px;"> </span><span style="bottom: 700px">{{ $data['data']['lifePathIndicator']['lifePathIndicator'] }}aa</span>
            </div>
            <div class="t m0 x51 h14 y1c8 ff1 fsc fc7 sc0 ls0 ws0" style="left: 45px;bottom: 205px">
                <span class="_ _27" style="width: 1640px;"> </span><span style="bottom: 680px">{{ $data['data']['missionIndicator']['missionIndicator'] }}aa</span>
            </div>
            <div class="t m0 x51 h14 y1c8 ff1 fsc fc7 sc0 ls0 ws0" style="left: 45px;bottom: 150px">
                <span class="_ _27" style="width: 1640px;"> </span><span style="bottom: 650px">{{ $data['data']['linkLifePathAndMission']['linkLifePathAndMission'] }}aa</span>
            </div>
            <div class="t m0 x51 h14 y1c8 ff1 fsc fc7 sc0 ls0 ws0" style="left: 45px;bottom: 105px">
                <span class="_ _27" style="width: 1640px;"> </span><span style="bottom: 600px">{{ $data['data']['maturityIndicator']['maturityIndicator'] }}aa</span>
            </div>
